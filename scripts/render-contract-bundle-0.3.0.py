#!/usr/bin/env python3
"""Render the authoritative substrate-wire 0.3.0 development bundle.
...
def schema(title: str, *, schema_id: str | None = None, **values: object) -> dict[str, object]:
    ...
    if schema_id is not None:
        result["$id"] = f"urn:daemonloom:substrate-wire:0.3.0:{schema_id}"
...
pipe_session_capabilities_result = add_result(
    ...
    closed_object(
        {
            "capability_snapshot": {"pattern": "^sha256:[0-9a-f]{64}$", "type": "string"},
            "contract": {"const": "substrate-wire/0.3.0"},
...
for filename, vector_id, coverage, command, expected, postconditions in [
    (
        ...
        {"contract": "substrate-wire/0.3.0", "network": "none", "single_attachment": True},
            ...
            "generator": closed_object(
                {
                    ...
                    "name": {"const": "scripts/render-contract-bundle-0.3.0.py"},
                    "version": {"const": "1"},
                },
                ["name", "version", "digest"],
            ),
    ...
    **closed_object(
        {
            ...
            "bundle": {"const": "substrate-wire@0.3.0"},
...
ORIGINS = {
    ...
    "bundle": "substrate-wire@0.3.0",
    "inputs": [
        {"name": "Daemonloom substrate contract", "origin": "daemonloom", "role": "wire semantics and conformance vectors", "trust": "repo-authored", "version": "0.3.0"},
        *[
...
def render() -> None:
    ...
    manifest = {
        ...
        "generator": {
            ...
            "name": "scripts/render-contract-bundle-0.3.0.py",
        "version": "1",
        },
        "name": "substrate-wire",
        "origin": "daemonloom",
