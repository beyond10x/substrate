...
def main() -> int:
    ...
    json_documents = check_json_authority(BUNDLE, "0.3.0", documents, validate, failures)
    ...
    if failures:
        ...
        return 1
    print(
        f"substrate-wire 0.3.0: {len(listed)} files, {json_documents} classified JSON documents, "
