...
def schema(title: str, *, schema_id: str | None = None, **values: object) -> dict[str, object]:
    ...
    if schema_id is not None:
        result["$id"] = f"urn:b10x:substrate-wire:0.2.0:{schema_id}"
...
ORIGINS = {
    ...
    "inputs": [
        {"name": "B10x substrate contract", "origin": "b10x", "role": "wire semantics and conformance vectors", "trust": "repo-authored", "version": "0.2.0"},
        *[
