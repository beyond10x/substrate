...
- **Bounded processes.** Commands use an argument vector, a cleared and shaped environment, output
  caps, time bounds, and whole-tree termination.
...
public ingress product. It governs one machine or one handed-over cluster scope. Higher layers decide
...
- [Understand the system boundary](./concepts/boundary.md).
