...
This directory is the review inbox. A review remains here while any accepted finding is open.
After every finding has implementation or explicit disposition evidence, move the original review
unchanged into [`archived/`](archived/) and place its disposition beside it.
