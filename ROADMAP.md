...
|---:|---|---|---|
| 0 | Private design repository | private `daemonloom/substrate`, bot-authored `main`, portable docs | in progress |
...
| 6 | Stack adoption | connectors projection, one Flux adapter, and one autodev `Executor` adapter prove the public contract independently | pending |
